		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div v-if="showComments" class="overflow-auto pt-3"
					...
					<div v-for="comment in photoComments"
						 class="border border-secondary bg-white rounded-1 mb-2 mx-2 px-2 py-1">
				...
				<div class="mb-2">
					...
					<button class="btn btn-primary mt-2" @click="commentPhoto">Add comment</button>
				</div>

			</div>
			<div class="card-footer">
				<small class="text-muted">Uploaded time: {{ props.photo.uploadedAt }}</small>
			</div>
		</div>
	</div>
</template>
