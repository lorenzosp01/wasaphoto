...
func (rt *_router) Handler() http.Handler {
	...
	// Photo interactions
	rt.router.PUT("/profiles/:user_id/photos/:photo_id/likes/:auth_user_id", rt.wrap(rt.likePhoto, []string{database.UserTable, database.PhotoTable, database.UserTable}, true))
